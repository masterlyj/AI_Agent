...
# 使用当前文件夹内的.env文件
# 允许为每个light_graph_rag实例使用不同的.env文件
# 操作系统环境变量的优先级高于.env文件
